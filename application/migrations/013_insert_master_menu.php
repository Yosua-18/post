	...
	{ 
		// insert function value
		 $data_menu = array(
            ...
            array('id'=>6,'module_id'=>1, 'name'=>'Manage Account', 'url'=>'#', 'parent_id'=>1, 'icon'=>"fa fa-users", 'sequence'	=>3), 
            ...
            array('id'=>9,'module_id'=>1, 'name'=>'Bibit', 'url'=>'products', 'parent_id'=>1, 'icon'=>"fa fa-cubes", 'sequence'=>5), 
            array('id'=>10,'module_id'=>1, 'name'=>'Pengajuan', 'url'=>'order', 'parent_id'=>1, 'icon'=>"fa fa-bar-chart", 'sequence'=>6), 
