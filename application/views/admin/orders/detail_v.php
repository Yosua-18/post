                ...
                <div class="box-header">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p >Status Pengiriman : <span class="text-success bold">Di Kirim Ke Lokasi</span></p>
                            <p >Bukti Permintaan : 
                            <img width="100px" src="<?php echo base_url()?>uploads/bayar/<?php echo $data_orders->file_bayar?>">
                            </p>
                          <?php }else{ ?>
                             <p class="text-right">Status Pengiriman : <span class="text-success bold">Belum di Kirim</span></p>
                         <?php }?>
                        </div>
                        <div class="col-md-6">
