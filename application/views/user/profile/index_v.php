                    ...
                    <div class="box-bordered mb-3">
                        <div class="box-header">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <p class="text-right">Total Permintaan : <span class="price bold">Rp <?php echo number_format($order->total_transaksi);?></span></p>
                                    <p class="text-right">Status Permintaan : <span class="text-success bold">Permintaan Berhasil</span></p>
                                    <p class="text-right">Status Pengiriman : 
                                        <?php if($order->status_bayar == 0){?>
                                            <span class="text-danger bold">Belum di Kirim</span>
                                        <?php }else{?>
                                            <span class="text-success bold">Di kirim</span>
                                        <?php }?>
